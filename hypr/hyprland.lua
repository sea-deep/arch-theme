...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("/home/dipak/code/arch-theme/hypr/scripts/set_wallpaper.sh")
...
hl.bind(mainMod .. " + comma", hl.dsp.exec_cmd("sh -c '$HOME/code/arch-theme/hypr/scripts/toggle_osk.sh'"))
hl.bind(mainMod .. " + SHIFT + P", hl.dsp.exec_cmd("sh -c '$HOME/code/arch-theme/quickshell/scripts/power_profile.sh cycle'"))

...
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd("sh -c 'qs ipc call clipboard toggle \"$(hyprctl cursorpos)\"'"))
hl.bind(mainMod .. " + period", hl.dsp.exec_cmd("sh -c 'qs ipc call emoji toggle \"$(hyprctl cursorpos)\"'"))
